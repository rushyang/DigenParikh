...
# grep will try to fetch the $myuser from output.. ^ means MUST be started from the given word.. and $ means MUST be ended from the given word.. Overall exactly THAT word should be exist in ONE particular line
